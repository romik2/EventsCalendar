    ...
    {      
      ...
      case 1:
        ...
        if (move_uploaded_file($_FILES['userfile']['tmp_name'], $uploadfile)) {
          $direction = 'uploads/'.$_FILES['userfile']['name'];
        }
        $date = $_GET[year].'-'.$_GET[month].'-'.$_GET[date];

        $res = $link->query("INSERT INTO `events` (`name`, `provisions`, `date`, `direction`, `type`) VALUES ('" . $_POST['name'] . "', '" . $_POST['provisions'] . "', '" . $date . "', '" . $direction . "', 0);");
